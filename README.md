...
| --- | --- | --- |
| `@fairylights-studio/button` | Extended FAB collapse motion variables | `--mat-sys-duration-*`, `--mat-sys-easing-standard`, official FAB/button variables |
...
`@fairylights-studio/button` adds the upstream-compatible `collapsed` input for Angular Material
